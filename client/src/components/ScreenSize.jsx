...
const ScreenSizes = (props) => {
	...
	return (
		<div className={`${styles.screenSize_container} flex_around`}>
            <div className={`${styles.button_group} flex_between`}>
                <button id='lg16_9' className={`${styles.button} ${styles.lg16_9} flex_center`} onClick={(e) => handleUpdateSize(e)}>16:9 lg</button> {/* 2560 x 1440 */}
                <button id='md16_9' className={`${styles.button} ${styles.md16_9} flex_center`} onClick={(e) => handleUpdateSize(e)}>16:9 md</button> {/* 1920 x 1080 */}
                <button id='sm16_9' className={`${styles.button} ${styles.sm16_9} flex_center`} onClick={(e) => handleUpdateSize(e)}>16:9 sm</button> {/* 1366 x 768 */}
            </div>
            <div className={`${styles.button_group} flex_between`}>
