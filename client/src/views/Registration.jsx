		...
		<div className="mt-custom d-flex flex-column justify-content-center align-items-center">
			...
			<div className="border-shadow color-bg-blue form-m mt-3 p-4 rounded">
				...
				<form onSubmit={handleSubmit}>
                        ...
                        <div className="position-relative">
                            <input
                                ...
                                className={"form-control form-input-m form-p-input text-50 border-shadow-inset w-100 mb-4 rounded" + 
                                    (formErrors.username ? " border-error-s border-shadow-error" : "")}
                                value={username}
					...
					<button type="submit" className={"transition-ease text-140 border-shadow-light border-none w-100 rounded" + 
                        (Object.keys(formErrors).every(key => formErrors[key] === "") ? " button-50-gray-red button-50-gray-red--h" : " button-50-gray-red--disabled")}>
						Register
					</button>
				</form>
			</div>
