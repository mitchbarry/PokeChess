...
const Update = () => {
    ...
    return (
        <div className="div">
            ...
            <div className="container d-flex flex-row col-12 border border-warning border-2 rounded-3 py-3 my-2" style={{ backgroundColor: 'rgb(51, 103, 153, 0.9)' }}>
                <div className="mx-auto">
                    <h2 className='text-warning'>Update {lobby.name}</h2>
                    <form onSubmit={handleSubmit} className="form-control mt-3 d-flex flex-column" style={{ background: 'linear-gradient(teal,rgba(51, 103, 153, 0.9),rgb(138,18,0))', width: '45vh' }}>
                        ...
                        <label className='form-label text-warning mt-1 pb-1' htmlFor="password"><h5>Password</h5></label>
                        <input className='form-control mt-1 mb-2' style={{ backgroundColor: 'rgb(234,224,200)', fontFamily: 'fantasy', color: 'goldenrod' }} type="password" name="password" value={lobby.password} onChange={handleChange} placeholder="Password"></input>
                        {/* {errors.password && <p>{errors.password.message}</p>} */}

                        <button className='col-12 text-warning mt-2 border borrder-info  my-3' style={{ backgroundColor: 'rgb(138,18,0)' }}>Update this Lobby </button>
